...
from FinamPy.grpc.assets.assets_service_pb2 import AssetsRequest, AssetsResponse, GetAssetRequest, GetAssetResponse  # Информация по тикеру
...
if __name__ == '__main__':  # Точка входа при запуске этого скрипта
    ...
    for dataname in datanames:  # Пробегаемся по всем тикерам
        finam_board, symbol = fp_provider.dataname_to_finam_board_ticker(dataname)
