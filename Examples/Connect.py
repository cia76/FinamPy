...
from FinamPy.FinamPy.grpc.assets.assets_service_pb2 import ClockRequest, ClockResponse  # Время на сервере
from FinamPy.FinamPy.grpc.marketdata.marketdata_service_pb2 import SubscribeBarsResponse, Bar  # Подписка на минутные бары тикера
from FinamPy.FinamPy.grpc.marketdata.marketdata_service_pb2 import TimeFrame  # Временной интервал Финама
