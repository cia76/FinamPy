...
Решение не хранить токен в защиденном системном хранилище связано с тем, что длина токена гораздо больше 512-и символов. Что не допустимо в Windows. Для Linux систем подобных ограничений нет.
Но из-за поддержки кроссплатформенности, приходится использовать не самый лучший вариант. 
