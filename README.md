...
### Особенности
- Из спецификации фьючерса невозможно выделить фьчерсы на сырье
...
Вызовите библиотеку из Python с новым токеном: fp_provider = FinamPy('<Токен>'). Токен сохранится в защищенном системном хранилище. Далее можно вызывать библиотеку без токена: fp_provider = FinamPy()
